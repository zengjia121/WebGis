...
let source_tiandi = new XYZ({
    tileUrlFunction: function(tileCoord) {
        if (tileCoord) {
            ...
            let x = tileCoord[1];
            let y = -tileCoord[2] - 1;
            return 'https://t0.tianditu.gov.cn/DataServer?tk=b08ac43905fb06a2a1f0519594588b40&T=vec_w&x=' + x + '&y=' + y + '&l=' + z;
        } else {
            return '';
        }
    }
...
let source_tiandisat = new XYZ({
    tileUrlFunction: function(tileCoord) {
        if (tileCoord) {
            ...
            let x = tileCoord[1];
            let y = -tileCoord[2] - 1;
            return 'https://t0.tianditu.gov.cn/DataServer?tk=b08ac43905fb06a2a1f0519594588b40&T=img_w&x=' + x + '&y=' + y + '&l=' + z;
        } else {
            return '';
        }
    }
...
let source_tdtlabeldz = new XYZ({
    tileUrlFunction: function(tileCoord) {
        if (tileCoord) {
            ...
            let x = tileCoord[1];
            let y = -tileCoord[2] - 1;
            return 'https://t0.tianditu.gov.cn/DataServer?tk=b08ac43905fb06a2a1f0519594588b40&T=cva_w&x=' + x + '&y=' + y + '&l=' + z;
        } else {
            return '';
        }
    }
...
let source_tdtlabelwx = new XYZ({
    tileUrlFunction: function(tileCoord) {
        if (tileCoord) {
            ...
            let x = tileCoord[1];
            let y = -tileCoord[2] - 1;
            return 'https://t0.tianditu.gov.cn/DataServer?tk=b08ac43905fb06a2a1f0519594588b40&T=cia_w&x=' + x + '&y=' + y + '&l=' + z;
        } else {
            return '';
        }
    }
